                                            ...
                                            <tr>
                                                ...
                                                <td><Link to={`${process.env.PUBLIC_URL}/product/${item.id}`}>{item.productName}</Link>
                                                    <div className="mobile-cart-content row">
                                                        ...
                                                        <div className="col-xs-3">
                                                            <h2 className="td-color">{symbol}{item.productPrice}
                                                            <del><span className="money">{symbol}{item.productPrice + 10}</span></del></h2>
                                                        </div>
                                                        <div className="col-xs-3">
                                                ...
                                                <td><h2>{symbol}{item.productPrice - 10}
                                                     <del><span className="money">{symbol}{item.productPrice}</span></del></h2></td>
                                                <td >
                                                    <p>in stock</p>
                                                </td>
                                                <td>
